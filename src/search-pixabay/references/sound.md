...
- `film+%26+special+effects`：转场、冲击、预告片、whoosh、riser、hit、reveal、boom、sweep、logo 音效
...
**方案一（最宽）**：
```
https://pixabay.com/sound-effects/search/door+creak/
```

**方案二（适中）**：
```
https://pixabay.com/sound-effects/search/door+creak/?theme=horror&duration=0-30
```

**方案三（备选）**：
```
https://pixabay.com/sound-effects/search/door+open+scary/?theme=horror&duration=0-30
```
