...
**方案一（最宽）**：
```
https://pixabay.com/photos/search/technology+background/?orientation=horizontal
```

**方案二（适中）**：
```
https://pixabay.com/photos/search/technology+background/?orientation=horizontal&min_width=1920&colors=blue
```

**方案三（最窄）**：
```
https://pixabay.com/photos/search/technology+background/?orientation=horizontal&min_width=1920&min_height=1080&colors=blue&content_type=ai
```
